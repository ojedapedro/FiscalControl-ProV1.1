...
export const SENIAT_DECLARATIONS_TAX_CONFIG: Record<string, { label: string; deadlineDay: number; items: { code: string; name: string; amount?: number; isVariable?: boolean; frequency?: PaymentFrequency }[] }> = {
  'DECLARACIONES': {
    ...
    items: [
      ...
      { code: '7.2.4', name: 'LIBRO DE VENTA - CODIGO 4', isVariable: true, frequency: PaymentFrequency.MONTHLY },
      { code: '7.2.5', name: 'LIBRO DE VENTA - CODIGO 5', isVariable: true, frequency: PaymentFrequency.MONTHLY },
      { code: '7.2.6', name: 'LIBRO DE VENTA - TOTAL', isVariable: true, frequency: PaymentFrequency.MONTHLY },
